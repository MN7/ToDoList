...
class Form extends Component {
  ...
  onClickEdit = e => {
    this.errmsg = "";
    if (e.length < 1) {this.errmsg="To-Do Item must not be blank"; }
    if (this.props.getTDItems().toString().indexOf(e.toString()) >= 0) { this.errmsg="To-Do Item already exists"; }
    if (this.errmsg === "") {this.props.onClickEdit(e); }
  };
    ...
    return (
      <form>
        ...
        <Box name="statictable" my={3}>
          <TDTable rows={this.props.getUpdtState()} onClickEdit={this.onClickEdit} onClickDelete={this.onClickDelete}
                   startEditing={e => this.props.startEditing(e)} stopEditing={e => this.props.stopEditing(e)} canEditNow={e => this.props.canEditNow(e)}
                   saveEdit={e => this.saveEdit(e)} cancelEdit={e => this.cancelEdit(e)} getEditIdx={e => this.props.getEditIdx(e)} errmsg={this.errmsg}
          />
        </Box>
